...
Authoritative source: Supabase tables canon_subjects, canon_topics,
canon_sub_topics, canon_level_topics (DB enforces FK).
Counts:
• Mathematics: 26 topics, 130 sub_topics
• Science:      6 topics,  41 sub_topics
• English:      7 topics,  32 sub_topics
• TOTAL:       39 topics, 203 sub_topics
• canon_level_topics: 296 (level, subject, topic, sub_topic) rows
