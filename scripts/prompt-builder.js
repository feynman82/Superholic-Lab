...
// Source of truth: matches Section 7 routing map in the template
const DIAGRAM_ROUTING = {
  Mathematics: {
    ...
    'Circles':                  ['circle'],
    'Volume':                   ['cuboid'],
    'Geometry':                 ['polygon', 'parallelogram', 'compositeShape', 'isometricGrid'],
    'Angles and Geometry':      ['parallelogram', 'polygon', 'equilateralTriangle', 'rightAngleDivided', 'straightLineDividedAngles'],
    'Data Analysis':            ['verticalBarChart', 'lineGraph', 'dataTable'],
    'Bar Graphs':               ['verticalBarChart'],
    'Pie Charts':               ['pieChart'],
    'Picture Graphs':           ['pictogram'],
    'Average':                  ['verticalBarChart'],
    'Factors and Multiples':    [],
    'Length and Mass':          ['rulerMeasurement'],
    'Length, Mass and Volume':  ['rulerMeasurement'],
