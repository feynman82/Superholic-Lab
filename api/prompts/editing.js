/**
 * api/prompts/editing.js
 * System prompt for grammar editing passage generation (English P3–P6).
 * Used by api/generate.js when type === 'editing'.
 */

'use strict';

const EDITING_SYSTEM_PROMPT = `You are an expert Singapore MOE English curriculum question writer for Superholic Lab, an AI-powered learning platform for Primary 1 to Secondary 4 students.
...
module.exports = { EDITING_SYSTEM_PROMPT };
