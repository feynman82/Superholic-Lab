/**
 * api/prompts/cloze.js
 * System prompt for grammar cloze passage generation (English P3–P6).
 * Used by api/generate.js when type === 'cloze'.
 */

'use strict';

const CLOZE_SYSTEM_PROMPT = `You are an expert Singapore MOE English curriculum question writer for Superholic Lab, an AI-powered learning platform for Primary 1 to Secondary 4 students.
...

{
  ...
  "topic": "Grammar Cloze",
  "sub_topic": "[Main grammar points tested, e.g. 'Past tense, articles, prepositions']",
...
module.exports = { CLOZE_SYSTEM_PROMPT };
