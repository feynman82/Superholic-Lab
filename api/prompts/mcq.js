 ...
 * Used by api/generate.js when type === 'mcq'.
 */

'use strict';

const MCQ_SYSTEM_PROMPT = `You are an expert Singapore MOE curriculum question writer for Superholic Lab, an AI-powered learning platform for Primary 1 to Secondary 4 students.
...

{
  ...
  "wrong_explanations": {
    "[wrong letter]": "[specific misconception + why wrong]",
    "[wrong letter]": "[specific misconception + why wrong]",
    "[wrong letter]": "[specific misconception + why wrong]"
  },
...
module.exports = { MCQ_SYSTEM_PROMPT };
