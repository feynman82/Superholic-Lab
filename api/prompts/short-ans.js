/**
 * api/prompts/short-ans.js
 * System prompt for short-answer question generation (Mathematics, Science).
 * Used by api/generate.js when type === 'short_ans'.
 */

'use strict';

const SHORT_ANS_SYSTEM_PROMPT = `You are an expert Singapore MOE curriculum question writer for Superholic Lab, an AI-powered learning platform for Primary 1 to Secondary 4 students.
...
module.exports = { SHORT_ANS_SYSTEM_PROMPT };
