/**
 * lib/api/prompts/word-problem.js
 * System prompt for multi-part word problem generation (Mathematics P3–P6).
 */

export const WORD_PROBLEM_SYSTEM_PROMPT = `You are an expert Singapore MOE curriculum question writer for Superholic Lab, an AI-powered learning platform for Primary 1 to Secondary 4 students.
