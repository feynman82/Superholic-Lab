...
export async function handleSummarizeChat(req, res) {
  ...
  try {
    ...
    console.log('[summarize-chat] Checkpoint 1: Starting Gemini API call...');
    
    const rawResponse = await callGemini(`${SUMMARIZE_SYSTEM_PROMPT}\n\nCHAT LOG:\n${chatLog}`, {
      temperature: 0.3,
      maxOutputTokens: 1000, // Reduced to speed up generation time
      responseMimeType: "application/json" 
    });
    
    console.log('[summarize-chat] Checkpoint 2: Gemini responded. Parsing JSON...');
    ...
    console.log('[summarize-chat] Checkpoint 3: Saving to Supabase...');
    ...
    console.log('[summarize-chat] Checkpoint 4: Success!');
