...
const topics = [
  { name: 'Whole Numbers', pct: 78, band: 'AL3' },
  { name: 'Fractions', pct: 62, band: 'AL5' },
  { name: 'Ratio', pct: 41, band: 'AL6', weak: true },
  { name: 'Geometry', pct: 55, band: 'AL5' },
];

export default function PillarDiagnose() {
        ...
        <div className="pillar-grid">
          <div className="pillar-text">
            <FadeUp>
              ...
              <p className="body-lg">
                Bayesian Knowledge Tracing scores every topic. Live AL band per subject. The dashboard shows exactly where mastery is — and exactly where it isn&apos;t.
              </p>
              <ul className="rose-list pillar-bullets">
                <li>BKT mastery score per topic and sub-topic</li>
          ...
          <div className="pillar-visual" ref={ref} data-pillar-viz="al-band">
            <div className="card-glass al-mock">
              <div className="al-mock-head">
                <span className="label-caps">Topic Mastery — Mathematics P5</span>
                <span className="al-mock-overall">
                  <span className="label-caps">Overall</span>
                  <span className="al-mock-overall-band">
                    AL<CountUp to={5} />
                  </span>
                </span>
              </div>
                ...
                <div className="al-mock-row" key={t.name}>
                  ...
                  <div className="al-mock-bar">
                    <motion.span
                      ...
                      style={{ background: t.weak ? 'var(--brand-rose)' : 'var(--maths-colour)' }}
                    />
                  </div>
              ...
              >
                ▸ Ratio needs work — root cause traced next
              </motion.div>
            </div>
          </div>
        </div>
